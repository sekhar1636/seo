 ...
 <table width=\"70%\" border=\"1\" align=\"center\">
    <tr> 
      <td colspan=\"3\" bgcolor=\"#99FFCC\"> 
        <div align=\"center\"><b><h>Update your Audition Information:</h2></b></div>
      </td>
    </tr>
    <tr> 
...
Did you do Summer Stock last year. 
...
echo "    
    <tr>     
      ...
      Would you consider accepting an unpaid apprentice position?     
...
echo "        
    ...
    <tr> 
      <td>
        ...
        An internship involving crew work as well as performing: 
...
";
	  ...
	  if($mononly == "N") {
        ...
        <input type=\"radio\" name=\"mononly\" value=\"Y\" tabindex=\"15\">Monologue Only Audition OR<br>
	  	<input type=\"radio\" name=\"mononly\" value=\"D\" tabindex=\"15\">Dancers Who Sing Audition (Sunday)<BR>      
        </div>"; 
	  }
        ...
        <input type=\"radio\" name=\"mononly\" value=\"Y\" checked tabindex=\"15\">Monologue Only Audition OR<br>
	  	<input type=\"radio\" name=\"mononly\" value=\"D\" tabindex=\"15\">Dancers Who Sing Audition<BR>    
        <i>(Sunday Only)</i>
        </div>"; 
	  	}
	  	...
	  	<input type=\"radio\" name=\"mononly\" value=\"N\" tabindex=\"15\"><b>Song & Monologue Audition OR<br>
        <input type=\"radio\" name=\"mononly\" value=\"Y\" tabindex=\"15\">Monologue Only Audition OR<BR>
	  	<input type=\"radio\" name=\"mononly\" value=\"D\" checked tabindex=\"15\">Dancers Who Sing Audition<BR>
        <i>(Sunday Only)</i>
        </div>";
	  	 }
echo "<p>

<a href=\"../aud_type.pdf\" target=\"myNewWin\" onClick=\"sendme()\"    
        ONMOUSEOVER=\"this.style.color='red'\" ONMOUSEOUT=\"this.style.color='blue'\">
     
     Help: What are the different auditions?</a>
    ...
    <tr> 
      <td align = \"center\"><B>Will you accept a <i><u>Standby</u></i> appointment</B> 
...
echo "
    ...
    <tr> 
      <td> 
        <b>Employment Availability From:</b> Month  
...
echo "
    ...
    <tr> 
      <td>
        <b>Employment Availability To:</b> &nbsp &nbsp Month  
       ";
