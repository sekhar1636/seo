...
$sql = "SELECT * FROM actor11 WHERE actor_uid = $actor_uid";
...
<html>
<head>
<title>StrawHat Update Actor Information</title>
...
<!--
function validateForm(actor)
{
	if(!validateFirstname(actor.firstname.value) )
		{
			actor.firstname.focus();
			return false;
		}

	else if(!validateLastname(actor.lastname.value) )
		{
			actor.lastname.focus();
			return false;
		}
	
	else if(!validateAddress(actor.address.value) )
		{
			actor.address.focus();
			return false;
		}

	else if(!validateCity(actor.city.value) )
		{
			actor.city.focus();
			return false;
		}

	else if(!validateState(actor.state.value) )
		{
			actor.state.focus();
			return false;
		}

	else if(!validateZip(actor.zip.value) )
		{
			actor.zip.focus();
			return false;
		}

	else if(!validateEmail(actor.email.value) )
		{
			actor.email.focus();
			return false;
		}
	else if(!validatePhone(actor.phone.value) )
		{
			actor.phone.focus();
			return false;
		}
	else if(!validateLargeCity(actor.largecity.value) )
		{
			actor.largecity.focus();
			return false;
		}
}
...
echo "<h2 align = \"center\">Update your Actor Information here:</h2>	
    </tr>	
</table>
";
...
<form name=\"actor\" ONSUBMIT=\"return validateForm(actor)\" method=\"POST\" action=\"actor_modifyrecord3.php\">
<input type = \"hidden\" name = \"actor_uid\" value = \"$actor_uid\">
  ...
  <table width=\"65%\" border=\"1\" align=\"center\">
    ...
    <tr> 
      <td width=\"49%\"> <b>First Name:</b>
        ...
        <br>
        <b>Middle:</b> 
        <input type=\"text\" name=\"midname\" maxlength=\"20\" size=\"20\" value=\"$midname\">
        <br>
        <b>Last Name:</b> 
        <input type=\"text\" name=\"lastname\" size=\"30\" maxlength=\"30\" value=\"$lastname\">
      </td>
      
      <td width=\"49%\"> <b>Address:</b> 
        <input type=\"text\" name=\"address\" maxlength=\"40\" size=\"40\" value=\"$address\">
        <br>
        <B>City:</B> 
        <input name=\"city\" size=\"30\" type=\"text\" maxlength=\"30\" value=\"$city\">
        <br>
        <B>State:</B> 
...
";
    ...
    <tr> 
      <td width=\"49%\"><b>Phone:</b>
        ...
        <BR>
        <b>(H)ome, (O)ffice, (S)ervice, (C)ell </b> 
...
echo "
        ...
        <b> </b></td>
      <td colspan=\"3\" width=\"51%\"><b>Nearest Largest City (if not already shown): 
...
echo "
    ...
    <tr> 
      ...
      <font size = '3'><b>IMPORTANT!:</b> When you enter your website url, <BR>
      <b>Do Not include the http://</b>
      <br>
      <br>
      ...
      <td colspan=\"3\" width=\"45%\"> 
        <div align=\"left\">&lt;== Your acting website and/or places that show 
          your work. Your website address is limited to 65 characters. If you have any problems, let us know at info@strawhat-auditions.com</div>
      </td>
    </tr>
    <tr> 
      <td colspan=\"4\"> 
