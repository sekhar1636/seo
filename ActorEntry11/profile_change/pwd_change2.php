...
<HTML>
<HEAD>
<TITLE>Strawhat Updated Actor Username and Password</TITLE>
...
if (!$actor_uid) {
	echo("<p align = \"center\">Can't see $actor_uid. Contact us at info@strawhat-auditions.com if you keep getting this error</p>");
	exit;
	}

if(!$p_entered) {
	echo" <p align = \"center\">Please enter a password. Use the Back button to get to previous screen.</p>";
	exit;
}

if(!$p_entered2) {
	echo" <p align = \"center\">Please confirm your password. Use the Back button to get to previous screen.</p>";
	exit;
}

if(!$u_entered) {
	echo"<p align = \"center\">Please enter a username. Use the Back button to get to previous screen.</p>";
	exit;
}

if(!$p_hint) {
	echo"<p align = \"center\">Please enter a hint for the password. Use the Back button to get to previous screen.</p>";
	exit;
}


if($p_entered != $p_entered2) {
	echo"<p align = \"center\">Confirming password does not match password. Use the Back button to get to previous screen. Please make sure your new password and the confirming password match.</p>";
	exit;
}
