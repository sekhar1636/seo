...
$sql_part1 = "SELECT tech_uid, firstname, lastname,
	techapp_uid, other, job1, job2
	FROM techies10, techapp10 
	WHERE techies10.tech_uid = techapp10.techapp_uid AND job1=\"";

$sql_part2 = "\" OR techies10.tech_uid = techapp10.techapp_uid AND job2=\"";
