...
if (!$sel_record) {
	...
	header("Location: http://localhost/Members10/Tech/techie_searchlastname.php");
	echo " No sel_record";
	exit;

	}

$sql_test = "SELECT * FROM techroles10
WHERE techroles_uid = \"$sel_record\"
";
	
$sql = "SELECT *
FROM techies10, techapp10, techroles10
WHERE techies10.tech_uid = \"$sel_record\"
AND techies10.tech_uid = techapp10.techapp_uid
AND techapp10.techapp_uid = techroles10.techroles_uid
";
...
<HTML> 
  <HEAD> 
	 <TITLE>2010 StrawHat Staff Tech Design Search: $lastname, $firstname: $job1</TITLE>
...
echo "<BR>
		<a href = \"tech_resume/$resume_link\">Link to Resume</a>
		  </TD>
		  <td>&nbsp</td
		  </TR> 
...
echo "		
		...
		if($url1 ||$url2) {
			echo "
		<tr>
			<td colspan = \"4\">Websites: $url1, $url2</td>
		</tr>
		";}
echo "			
		<tr>
