...
<HTML>
<HEAD>
<TITLE>StrawHat Labels Program</TITLE>
...
//successful update
	$count++;	
echo "<p>$lastname, $firstname<BR>
Available: $label_availfor - $label_availto</p>";
