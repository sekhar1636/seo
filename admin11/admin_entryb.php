...
if($type_lastname) {
	echo " 
	<H1 align=\"center\">Select Lastname Search Results for Actors</H1>
...
if($tech_lastname) {
	echo "
	<H1 align = \"center\">Select Lastname Search Results for Staff/Tech/Design</H1>
...
if(empty($new_lastname)) {
			echo "<P align = \"center\">No Match Found: <a href=\"member_entrya.php\">Please go back</a> and try again
