...
//is it a tech username?
if ($tech_lastname) {	
//END OF NO NAME SELECTION CODE--------------------------------------------------------
...
//specify whether you got an actor uid or an tech uid!!!
...
//if there is an app type, then TECH data, otherwise ACTOR data
...
//actors section---------------------------------------------------------------
//change to if(typename) instead of else

if($type_lastname) {
$sql = "SELECT actor_uid, lastname, firstname, pass_uid, pass, username
FROM actor10, pwd10
