...
if($type1 == "V") {
	...
	<A HREF = \"$port_link1\" target=\"RecordViewer\" onClick=\"sendme() ALT=\"Video Link 1\"><b><u><font face=\"Arial, Helvetica, sans-serif\"><font size=\"+1\">VIDEO 1</font></font></u></b></A>
...
if($type1 == "F") {
    ...
    echo "<IMG SRC=\"../Tech/record.gif\" ALT=\"*\">
    <A HREF = \"../Tech/tech_media/$port_link1\" 
    target=\"RecordViewer\" onClick=\"sendme() ALT=\"PDF Link\"    
    ALT=\"PDF1 Link\"><b><u><font face=\"Arial, Helvetica, sans-serif\"><font size=\"+1\">PDF 1</font></font></u></b></A>
    <IMG SRC=\"../Tech/record1.gif\" ALT=\"*\">
";        
}
...
<!-- AREA FOR PIX AND VIDEO AND AUDIO -->
		<td align = \"center\" width = \"300px\">
...
if($type2 == "V") {
	...
	echo "<IMG SRC=\"../Tech/record.gif\" ALT=\"*\">
	<A HREF = \"$port_link2\" target=\"RecordViewer\" onClick=\"sendme() ALT=\"Video Link\"><b><u><font face=\"Arial, Helvetica, sans-serif\"><font size=\"+1\">VIDEO 2</font></font></u></b></A>
	<IMG SRC=\"../Tech/record1.gif\" ALT=\"*\">
";		
}
...
if($type2 == "F") {
    ...
    echo "<IMG SRC=\"../Tech/record.gif\" ALT=\"*\">
    <A HREF = \"../Tech/tech_media/$port_link2\" 
    target=\"RecordViewer\" onClick=\"sendme() ALT=\"PDF Link\"    
    ALT=\"PDF2 Link\"><b><u><font face=\"Arial, Helvetica, sans-serif\"><font size=\"+1\">PDF 2</font></font></u></b></A>
    <IMG SRC=\"../Tech/record1.gif\" ALT=\"*\">
";        
}
...
if($type3 == "V") {
	...
	echo "<IMG SRC=\"../Tech/record.gif\" ALT=\"*\">
	<A HREF = \"$port_link3\" target=\"RecordViewer\" onClick=\"sendme() ALT=\"Video Link\"><b><u><font face=\"Arial, Helvetica, sans-serif\"><font size=\"+1\">VIDEO 3</font></font></u></b></A>
	<IMG SRC=\"../Tech/record1.gif\" ALT=\"*\">
";		
}
...
if($type3 == "F") {
    ...
    echo "<IMG SRC=\"../Tech/record.gif\" ALT=\"*\">
    <A HREF = \"../Tech/tech_media/$port_link3\" 
    target=\"RecordViewer\" onClick=\"sendme() ALT=\"PDF Link\"    
    ALT=\"PDF Link\"><b><u><font face=\"Arial, Helvetica, sans-serif\"><font size=\"+1\">PDF 3</font></font></u></b></A>
    <IMG SRC=\"../Tech/record1.gif\" ALT=\"*\">
";        
}
...
if($type1 == "F") {
    echo "<p align = \"center\">$comment1</p>
";        
}
...
if($type2 == "F") {
    echo "<p align = \"center\">$comment2</p>
";        
}
...
if($type3 == "F") {
    echo "<p align = \"center\">$comment3</p>
";        
}
...
echo "<BR>";
//How to test name.pdf in database?
if ($resume_link != "") {
	echo "<a href = \"/Members11/Tech/tech_resume/$resume_link\" target=\"RecordViewer\" onClick=\"sendme()\">Link to Resume</a>";}
    else {echo "Resume Not Posted";} 
...
if($url1) {
		...
		<tr>
			<td colspan = \"5\">
            <a href = \"$url1\" target=\"RecordViewer\" onClick=\"sendme()\">Website (1)<a/>
...
if($url2) {
		...
		<tr>	
			<td colspan = \"5\">
			<a href = \"$url2\" target=\"RecordViewer\" onClick=\"sendme()\">Website (2)</a> 
			<BR>
            </td>
		</tr>
		";}		
...
//3-3-14, change to ref1 and col only, take out $email1    	
    if($ref1 && $co1) {
    	echo "
    <tr>
...
//3-3-14, change to ref1 and col only, take out $email1            
    ...
    <td>
    "; 
    if($email2 == "") {echo "Email: NA";} 
    else{echo" <b>Email: </b>$email2";}
    
    echo "
    </td>
    </tr>
    ";}
//3-3-14, change to ref1 and col only, take out $email            
    if($ref3 && $co3) {
    echo "
    <tr>   
    <td>
    ...
    <td>
    "; 
    if($email3 == "") {echo "Email: NA";} 
    else{echo" <b>Email: </b>$email3";}
