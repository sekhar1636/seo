...
if($audition_yes_no == "Y") //only good for AA actors
{
$day = $_POST['day'];
$time = $_POST['time'];
$hour = $_POST['hour']; 
...
//$day = $_POST['day'];
$time = $_POST['time']; echo "Time: $time";
//$hour = $_POST['hour'];
//$type = $_POST['type']; 
...
<tr>
<td align=\"center\">
<H2 align = \"center\">Actors That Did Not Get An Audition</H2>
<a href=\"advanced_actor_search.php\">Back to Advanced Search Menu</a><BR>
";
...
elseif($vocal == 'T') {echo "Vocal(Tenor), ";}
elseif($vocal == 'B') {echo "Vocal(Baritone), ";}
elseif($vocal == 'BR') {echo "Vocal(Bass Baritone), ";}
//elseif($vocal == 'BR') {echo "Vocal(Bass-Baritione) ";}
