...
<TABLE CELLPADDING=\"2\" CELLSPACING=\"2\" WIDTH=\"80%\" align = \"center\"> 
		<TR VALIGN=\"TOP\"> 
		  <TD VALIGN=\"TOP\" HEIGHT=\"33\" colspan=\"3\"><center><H1><U>$firstname $midname $lastname</U></H1></center></TD> 
		  <TD rowspan=\"7\"><IMG SRC=\"/Members11/Actors/ActorPix/$pix_link\" ALIGN=\"RIGHT\" BORDER=\"0\">
		  </td>
...
include("parse.inc");	
	...
	echo "
			  <B><center>Hair: </B>$hair * <B>Eyes: </B>$eye * <B>Ht: </B>$feet' $inches\" <B>Wt: </B>$wt lbs <B>Age Range: </B>$age_range
			  </center></I></FONT>
		  </td>
		 </tr>
		<tr>
...
echo "  </td>
		...
		<TD VALIGN=\"TOP\" ALIGN=\"LEFT\"><A HREF=\"/Members11/Actors/ActorRes/$resume_link\" target=\"RecordViewer\" onClick=\"sendme()\">CLICK HERE <BR>FOR FULL RESUME</A>
...
echo "		  
		 ...
		 <TD VALIGN=\"TOP\" ><b>Websites:</b><br>$url1, $url2</td> 
		</TR> 
...
//if count is zero there is no data and the row will not be echoed
	...
	echo "		
		<TR VALIGN=\"TOP\"> 
		  <TD VALIGN=\"TOP\" WIDTH = \"20%\"><B>Technical Skills:</B></TD> 
		  <TD COLSPAN=\"3\" VALIGN=\"TOP\"> ";
