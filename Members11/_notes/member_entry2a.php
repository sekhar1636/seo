...
//MEMBERS11REMOTE, ENTRY FOR ACTORS AND THEATRES
?>	
...
$sql_result = mysql_query($sql,$connection) or die("Couldn't execute Tech query.");
...
<BODY BACKGROUND=\"../graphics03/Bk11a.GIF\">
...
*/ 
 ...
 <a href = \"StrawHatBrowserSetup.pdf\" target=\"myNewWin\" onClick=\"sendme()\"> review our recommendations for using tabs with your browser</a>. The StrawHat Forum and the links below will open in a new window, that will reflect the content you select. The other links will go to new pages and you will have to log in again to see this page.</p>
...
<p> 
 ...
 <b>Your audition day and time has been mailed to you</b>; when you receive it be sure to check that it is correct. You can also review the complete Schedule of Actors Auditions by going to Actor Search, which lists all the auditioning actors by last name and includes day/time, type of audition and standbys (will be updated shortly). Please take the opportunity to review <a href = \"why_list1.php\" target=\"myNewWin\" onClick=\"sendme()\"><b>The DREADED List</b></a> in the articles section of the site; and a copy of the confirmation sent to you by mail <a href =\"";
	...
	switch ($mononly){
		...
		case "D":
			...
			echo "Dancer2012_WEB.pdf";

			break;

		case "Y":

			echo "NonSing2012_WEB.pdf";

			break;

		case "N": 

		 	echo "Singer2012_WEB.pdf";
 ...
 echo " \" target=\"myNewWin\" onClick=\"sendme()\"><i><b>HERE</b></i></a> <BR><BR>If you have not done so, take a moment to read the <a href = \"AuditionInfo_2012.pdf\" target=\"myNewWin\" onClick=\"sendme()\"><b>Prep for Auditioning Actors</b></a> which covers when to show up, what to bring, what to wear and what to expect. A must read review!</p>
...
echo "
	 ...
	 <p>Please note the information on this page before using the links above</b> and 

 <a href = \"StrawHatBrowserSetup.pdf\" target=\"myNewWin\" onClick=\"sendme()\"> review our recommendations for using tabs with your browser</a>.
...
Please note the information on this page before using the links above</b> and 
