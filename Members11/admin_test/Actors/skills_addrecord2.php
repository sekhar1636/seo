...
<HTML>
<HEAD>
<TITLE>Adding 2005 record to Skills table</TITLE>
</HEAD>
<BODY>
...
if(!isset($combat)) {
	...
	$sql = "INSERT INTO skills05 (skills_uid, vocal, ballet, mus_thea, ballroom, tap, swing, jazz, 
		banjo, drumes, perc, trombone, 
		cello, flute, piano, trumpet,
		clarinet, guitar, saxophone, violin,
		acrobatics, juggling, puppetry, asl, painting, combat,
		set_design, lights, costume, stagem, box_office, props)
	VALUES ('$skills_uid', '$vocal', '$ballet', '$mus_thea', '$ballroom', '$tap', '$swing', '$jazz',
		'$banjo', '$drums', '$perc', '$trombone',
		'$cello', '$flute', '$piano', '$trumpet',
