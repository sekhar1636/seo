<?php
//profile_addrecord.php

//if (!$sel_record) {
//	header("Location: http://localhost/Members05/actors/actor_searchlastname.php");
//	exit;
//	}
...
//$sql = "SELECT * FROM actor05 WHERE actor_uid = $uid"";

/*
$sql = "SELECT * 
FROM actor05, physical05
WHERE actor05.actor_uid = \"$sel_record\"
and actor05.actor_uid = physical05.phys_uid
";
*/


$sql = "SELECT *
FROM actor05, physical05, skills05, roles05
WHERE actor05.actor_uid = \"$uid\"
and actor05.actor_uid = physical05.phys_uid
and physical05.phys_uid = skills05.skills_uid
and skills05.skills_uid = roles05.roles_uid
";
...
<IMG SRC=\"../../../graphics03/strawcasting.jpg\" WIDTH=\"400\" HEIGHT=\"45\"
	 BORDER=\"0\" ALIGN=\"BOTTOM\"><IMG SRC=\"/Members05/Actors/ActorPix/$pix_link\" ALIGN=\"RIGHT\" BORDER=\"0\"> 
...
echo "		  
		  ...
		  <TD VALIGN=\"TOP\" ALIGN=\"CENTER\"><A HREF=\"/Members05/Actors/ActorRes/$resume_link\" >CLICK HERE FOR FULL RESUME</A></TD> 
		</TR> 
