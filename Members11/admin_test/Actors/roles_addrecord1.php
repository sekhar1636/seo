<?php
//roles.addrecord1.php

if (!$sel_record) {
	header("Location: http://localhost/Members05/admin_test/actors/add_rolls04.php");
	exit;
	}
...
$roles_uid = $row["actor_uid"];


echo "
<HTML>
<HEAD>
<TITLE>2005 Add Roles Record</TITLE>
...
<h1>Add the following Roles Record:</h1>
<FORM method = \"POST\" action = \"roles_addrecord2.php\">
...
<input type=\"text\" name=\"roles_uid\" maxlength=\"5\" size=\"5\" value=\"$roles_uid\">
    ...
    <tr> 
      <td colspan=\"3\"> 
        <div align=\"center\"><a href=\"/Members04/admin_test/admin_menu.htm\">Back 
          to Main Menu</a></div>
      </td>
    </tr>
  </table>
