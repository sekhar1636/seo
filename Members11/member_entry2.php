...
<H2>StrawHat Member Entry - Login Failure  (App type: $app_type)</H2>
...
//execute SQL query and get result	
$sql_recresult = mysql_query($sql_rec11,$connection) or die("Couldn't execute query.");
...
<HTML> 
  <HEAD> 
	 <TITLE>StrawHat Auditions Acting Members</TITLE><LINK
	 REL=\"STYLESHEET\" HREF=\"members.css\"> 
  </HEAD> 
  <BODY BACKGROUND=\"Bk10a.GIF\"> <SCRIPT SRC=\"navbar.js\"></SCRIPT>
";
...
//if there is an audition AA and the theatre login does not appear
 ...
 echo " \">here.</a> <BR><BR>If you have not done so, take a moment to review the <a href = \"Audition_Info11.pdf\"><b>Prep for Auditioning Actors</b></a> which covers when to show up, what to bring, what to wear and what to expect. A must read review!</p>
...
echo "	 
	 ...
	 <P> <b>Actors</b>, as you prepare for your audition:
	 <UL>
	 	<LI>Read the Final Instructions that describes everything from when to show up to the Dance Call. Read it carefully, print it out and read it all!</LI>
		<LI>
	  	Take a look at the theaters
