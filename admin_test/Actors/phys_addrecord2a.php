<?php
	...
	if ((!$phys_uid)) {
	header("Location: http://localhost/Members05/admin_test/actor/add_physical04.htm");
	exit;
}
...
";
	include ("navbar.inc");
echo "	
<FORM method=\"POST\" action=\"skills_addrecord1a.php\">
<input type = \"hidden\" name = \"uid\" value = \"$phys_uid\">
<input type=\"submit\" value=\"Add Skills\" name=\"submit\">
</form>
	...
	<td valign=top>$age_range, $nativeam, $asian, $white, $black, $hispanic, $eeurope, $mideast, $indian</td>
	</tr>
