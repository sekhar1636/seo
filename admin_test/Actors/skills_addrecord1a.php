...
//$sql = "SELECT actor_uid FROM actor05 WHERE actor_uid = \"$uid\"";
...
<h1>StrawHat 2004 Actor Database: Add Skills Record</h1>
<form name=\"form1\" method=\"post\" action=\"skills_addrecord2a.php\">
