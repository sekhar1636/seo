...
/*
	if ((!$firstname)) {
	header("Location: http://localhost/Members05/admin_test/actor/add_actor04a.htm");
	exit;
}
*/
?>
...
$sql2 = "SELECT actor_uid, lastname, firstname 
		FROM actor05 
...
$sql_result = mysql_query($sql2,$connection) or die("Couldn't execute 2nd query.");
...
<FORM method=\"POST\" action=\"phys_addrecord1a.php\">
...
";
	...
	while ($row = mysql_fetch_array($sql_result) ) {
		...
		echo "
			<option value=\"$new_actor_uid\">$new_actor_uid: $new_lastname, $new_firstname</option>
			";
		}
