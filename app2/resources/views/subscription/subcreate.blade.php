                            ...
                            <div class="portlet light ">
                                <div class="portlet-title tabbable-line">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="active"> <a href="#tab_1_2" data-toggle="tab">{{ "Create" }}</a> </li>
                                    </ul>
                                </div>
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        ...
                                        @else
                                            ...
                                            {{ Form::model($sub,['method' => 'POST','route' => ['admin::adminSubView'], 'class' => 'form-horizontal']) }}

                                            <!-- input Area -->
                                                <div class="form-group{{ $errors->has('subscription_name') ? ' has-error' : '' }}">
                                                    {{ Form::label('name_lab', 'Title', ['class' => 'col-lg-2 control-label']) }}
                                                    <div class="col-lg-10">
                                                        {{ Form::text('subscription_name', null, ['class' => 'form-control', 'placeholder' => 'Enter Subscription Name','required'=>'required']) }}
                                                ...
                                                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-lg-10">
                                                        {{ Form::textarea('description', null, ['class' => 'form-control', 'rows' => 3,  'id' => 'editor', 'placeholder' => 'Description', 'required'=>'required']) }}
                                                ...
                                                <div class="form-group {{ $errors->has('number_days') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-lg-10">
                                                        {{ Form::text('number_days', null, ['class' => 'form-control', 'placeholder' => 'Enter number of Days','required'=>'required']) }}
                                                ...
                                                <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-lg-10">
                                                        {{  Form::select('type', ['Actor'=>'Actor', 'Theater'=>'Theater', 'Staff' => 'Staff'], null, array('class' => 'form-control', 'required'=>'required')) }}
