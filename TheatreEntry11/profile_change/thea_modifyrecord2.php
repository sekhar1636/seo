...
$vid_submission = $row["vid_submission"];
$where_submit = $row["where_submit"];
$_points = $row["emc_points"];
...
$where_submit = htmlspecialchars(stripslashes($where_submit));
...
<html>
<head>
<title align = \"center\">StrawHat Update Theatre Information</title>
...
echo "
<h2 align = \"center\">Update your Theatre Information here:</h2>
...
";
	...
	echo "
        ...
        Zip: 
        <input type=\"text\" name=\"zip\" maxlength=\"10\" size=\"10\" value=\"$zip\"></b> 
        <BR>
        <BR>
        </td>
    </tr>
    ...
    <tr> 
      ...
      <b>Phone:</b> 
        ...
        if($h_or_serv == "S") {
          echo "
          <option value = \"C\" selected>Service</option>"; }
        else {echo "
...
echo "
      ...
      if($largecity == "Knoxville") {
          echo "
          <option selected value=\"Knoxville\">Knoxville</option>"; }
        else {echo "
...
";
?>
<BR><P align = "center"><b>StrawHat Auditions, Pace University, New York City Schedule (Subject to Modification)</b></p>
<div align="center">
  <table width="72%" border="1" cellpadding="1">
    <tr> 
      <td width="28%"><b>2017 Dates</b> </td>
      <td width="43%"> 
        <div align="center"><b>Auditions</b></div>
      </td>
      <td width="29%"><b>Dance Call</b></td>
    </tr>
    <tr> 
      <td width="28%">Friday, March 17</td>
      <td width="43%">10:00 - 1:00 pm AND 2:00 - 6:00 pm</td>
      <td width="29%">7:00 - 8:30 pm</td>
    </tr>
    <tr> 
      <td width="28%">Saturday, March 18</td>
      <td width="43%">10:00 - 1:00 pm AND 2:00 - 6:00 pm</td>
      <td width="29%">7:00 - 8:30 pm</td>
    </tr>
    <tr> 
      <td width="28%">Sunday, March 19</td>
    ...
    <tr> 
      <td colspan="3"> 
        <div align="center">
        <i>Sunday March 19: Dancers Who Sing Call: 2:00-3:30 pm (see letter for details)</i>
        </div>
      </td>
    </tr>
  </table>
...
<tr>
<td>Please indicate the days will you be present.</td>

<td>  
";
//was 2016, sat, sun, monday
//no 2017, fri, sat, sun
//FRIDAY
    if(!empty($fri) ) {
          echo "<input type=\"checkbox\" name=\"fri\" value=\"fri\" checked>"; }
        else {echo "<input type=\"checkbox\" name=\"fri\" value=\"fri\">";}    
...
if(!empty($web_only) ) {
          echo "<input type=\"checkbox\" name=\"web_only\" value=\"web_only\" checked>"; }
        else {echo "<input type=\"checkbox\" name=\"web_only\" value=\"web_only\">";}    
...
<tr>
<td>
Do you accept video submisions?
</td>

<td>
<select name=\"vid_submission\" size=\"1\">
        ";        
      ...
      if($vid_submission == "M") {
          echo "
          <option value = \"M\" selected>Maybe</option>"; }
      else {echo "
...
<input type=\"text\" name=\"where_submit\" maxlength=\"50\" size=\"75\" value=\"$where_submit\">
</TD>
</tr>
...
<TR>
<td>
Do you offer EMC Points?
</td>

<td>
<select name=\"emc_points\" size=\"1\">
        ";        
...
<!-- table for reps -->   
    <table width=\"72%\" border=\"1\" align=\"center\">
    <tr>
   <td align = \"left\"><h3>Representatives who will attend StrawHats. (List up to 5 Reps)</H3></b></td>       
   <td><b>Title</b></td>
   </tr> 
   ...
   <td><input type=\"text\" name=\"title5\" maxlength=\"50\" size=\"50\" value=\"$title5\"></td> 
    ...
    <tr> 
      <td colspan=\"2\"> 
        <div align=\"left\">
        <H3>Registration Options: Choose One!</H3>
...
<!-- <h2 align = \"center\">Registration Options (choose one)</h2>-->
...
<!--    <table width=\"72%\" border=\"1\" align=\"center\"> -->
    <tr>       
        <td ><b>ATTEND THE NYC AUDITIONS</B>
   <br>
    Includes ONE set of Directories and web services: <b>$130</b>
    </td>
      
   <td border=\"1\" align=\"center\">
   <input type=\"text\" name=\"attend\" maxlength=\"4\" size=\"4\" value = \"$attend\">       
   </td>   
...
<!-- ONE DAY TRIAL -->   
   <tr>
   <td><b>ONE DAY TRIAL REGISTRATION</b> - please specify day of attendance 
   (Includes Directory only for the one day).<b> $60</B>
   <br>

   <td border=\"1\" align=\"center\">
   <input type=\"text\" name=\"trial\" maxlength=\"4\" size=\"4\" value = \"$trial\">          
   </td>
   </tr> 
   
<!-- Web Site Membership Only -->   
   <tr>
   <td><b>WEBSITE MEMBERSHIP ONLY</b> (List your theatre and job postings, access to Staff/Tech and Performer databases). <b>$35</b>
   </td>
   
   <br>
   
   <td border=\"1\" align=\"center\">
   <input type=\"text\" name=\"web_member\" maxlength=\"4\" size=\"4\" value = \"$web_member\">
   </td>
 ...
 <tr> 
      <td colspan=\"2\"> 
        <div align=\"left\">
        <H3>Callback Room Options: Choose One!</H3>
...
<!- CALL BACK ROOMS -->
 ...
 <!--
  <tr>
   <td><b>CALLBACK ROOMS (Please choose <b>ONE</b>:)</b><td>   
  <tr> 
   
 -->
   <br>
   <td>   
   All Day Access (10am - 11 pm). <b>$300</b><br>
   </td>   
   ...
   <tr>   
   <td>Daytime only (10am - 7pm). <b>$150</b><br>
   </td>
   ...
   <tr>
   <td>
   Evening (after Dance Call Only) <b>$150</b>
   </td>
...
<tr> 
   ...
   Piano Rental for Callback Room: <b>$250</b><br>
   </td>
   ...
   <td>
   Additional Set of Audition Directories: <b>$50 Each</b></br>
   </td>
   ...
   <tr>
   <td>
   Complete DVD set of audition weekend (includes web access): <b>$75</b>
   </td>
   <td>
   </td>
   </tr>
...
<BR>
Please include your check payable to StrawHat Auditions or 
provide credit card information below.
<br>
<br>
Name on Card:________________________________________________________ <br></br><br>

Billing Address (if diferent than above)</br>

Card Type (Circle one): Visa MC  Card Number____________________________<br></br>

Expiration Date: ______________________________ <br><br>

Security Code: ________________________________________________________ <br></br>

Card Holder Signature___________________________________________________ <br></br>       
...
<!--   
<tr>
   <td border=\"1\" align=\"center\">All Day access (10 am - 11 pm) <b>$300</b></br>
     
   Daytime only (10 am - 7 pm)</br>
   <td border=\"1\" align=\"center\">Evening (after Dance Call Only)</br></td>
