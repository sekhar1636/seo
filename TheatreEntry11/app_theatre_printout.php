...
$today = date("m.d.y");
echo "
<p class=\"title\" align=\"center\"><b>Mail your application to: The StrawHat Auditions, 1771 Post Road East, #315, Westport, CT 06880.</b>  <BR>Application Last Modified: $today.&nbsp &nbsp
...
";
  ...
  <tr> 
    <td colspan=\"2\"><u>Address</u>: $address</td>
    <td width=\"50%\"><u>Days</u>:Feb 18, Mon Afternoon 1pm (teaching)</td>
    </tr>
";
...
<BR>
<table width=\"80%\" bordercolor=\"#000000\" border=\"0\" align=\"center\">
  <tr> 
    <th align = \"left\"> 
      Shows
    </th>
...
<table width="53%" border="1" align = "center">
  <tr> 
    <td colspan="2" height="50"> 
      <div align="center"><font face="Arial, Helvetica, sans-serif"><b><font size="-1">Checklist 
        for complete application:<br>
        (NOTE: before printing your application, please check boxes below <br>
        to confirm you have included the following:</font></b></font></div>
    </td>
  </tr>
  <tr> 
    <td height="22" width="94%"><font face="Arial, Helvetica, sans-serif">(2) 
      Copies: Headshot and Resume stapled back to back.</font></td>
    <td width="6%" height="22"> <font face="Arial, Helvetica, sans-serif"> 
      <input type="checkbox" name="checkbox" value="checkbox">
      </font></td>
  </tr>
  <tr> 
    <td width="94%"><font face="Arial, Helvetica, sans-serif">(1) Check for Application 
      for $37 (Please sign your check!)</font></td>
    <td width="6%"> <font face="Arial, Helvetica, sans-serif"> 
      <input type="checkbox" name="checkbox2" value="checkbox">
      </font></td>
  </tr>
  <tr> 
    <td width="94%"><font face="Arial, Helvetica, sans-serif">(1) Check for Audition 
      for $47 (Please sign your check!)</font></td>
    <td width="6%"> <font face="Arial, Helvetica, sans-serif"> 
      <input type="checkbox" name="checkbox3" value="checkbox">
      </font></td>
  </tr>
  <tr> 
    <td width="94%"><font face="Arial, Helvetica, sans-serif">(2) Self Addressed 
      Business-Size Envelopes with postage (Forever Stamp or 45 cents)</font></td>
    <td width="6%"> <font face="Arial, Helvetica, sans-serif"> 
      <input type="checkbox" name="checkbox4" value="checkbox">
      </font></td>
  </tr>
  <tr>
    <td width="94%"><font face="Arial, Helvetica, sans-serif">(1) Printout of 
      your application</font></td>
    <td width="6%"><font face="Arial, Helvetica, sans-serif">
...
<tr>
    <td width="94%"><font face="Arial, Helvetica, sans-serif">(1) Emailed headshot 
      (jpg only) and resume (doc, rtf or pdf)</font></td>
    <td width="6%"><font face="Arial, Helvetica, sans-serif">
      <input type="checkbox" name="checkbox5" value="checkbox">
      </font></td>  
</tr>
...
<table width=\"94%\">
  <tr> 
    ...
    the information in this appliation is truthfull and correct. I understand that StrawHat 
