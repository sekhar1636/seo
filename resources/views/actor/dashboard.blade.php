                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-body inactiveBox">
                                            ...
                                            <div class="timeline-body-head">
                                                ...
                                                <div class="timeline-body-head-actions">
                                                    @if(\Auth::user()->payment_status == 1 && @$act->first_name != '' && @$act->last_name != '' && @$act->instrument != '' && @$act->ethnicity != '' && @$act->technical != '' && @$act->dance != '' && @$act->phone_number != '' && @$verify == 1 && \Auth::user()->email != '' && @$act->gender != '' && @$act->age != '' && @$act->vocalRange != '' && @$act->feet != '' && @$act->inch != '' && @$act->weight != '' && @$act->hair != '' && @$act->eyes != '' && @$act->misc != '' && @$act->from != '' && @$act->to != '' && @$act->auditionType != '')
