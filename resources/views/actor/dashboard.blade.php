                        ...
                        <div class="col-md-7">
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-body inactiveBox">
                                            ...
                                            <div class="timeline-body-content">
                                            	<span class="font-grey-cascade">If you do not receive an email within the next 15 minutes, resend the verification</span>
                                            </div>
                                        </div>
                                    </div>
	                            @endif
                                @if(\Auth::user()->actor->first_name == null)
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-body inactiveBox">
                                            ...
                                            <div class="timeline-body-content">
												<span class="font-grey-cascade"> Create Your profile and be a star.</span>
                                            </div>
                                        </div>
                                    </div>
								@else    
	                                @if(\Auth::user()->actor->first_name != Null && @$resume != '' && @$roles != '')
	                                    <div class="timeline-item">
	                                        ...
	                                        <div class="timeline-body activeBox">
	                                            ...
	                                            <div class="timeline-body-content">
													<span class="font-grey-cascade"> Profile Information Updated</span>
	                                            </div>
	                                        </div>
	                                    </div>
	                                @elseif(@$roles == '')
	                                    <div class="timeline-item">
	                                        ...
	                                        <div class="timeline-body inactiveBox">
	                                            ...
	                                            <div class="timeline-body-content">
	                                                <span class="font-grey-cascade"> Please Update Atleast one Role.</span>
	                                            </div>
	                                        </div>
	                                @elseif(@$resume == '')
	                                    <div class="timeline-item">
	                                        ...
	                                        <div class="timeline-body inactiveBox">
	                                            ...
	                                            <div class="timeline-body-content">
													<span class="font-grey-cascade"> Update Your resume information</span>
	                                            </div>
	                                        </div>
	                                    </div>
	                                @else
	                                    <div class="timeline-item">
	                                        ...
	                                        <div class="timeline-body inactiveBox">
	                                            ...
	                                            <div class="timeline-body-content">
													<span class="font-grey-cascade"> Update profile information</span>
	                                            </div>
	                                        </div>
	                                    </div>
	                                @endif
                                ...
                                @if(\Auth::user()->payment_status == 1)
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-body activeBox">
                                            ...
                                            <div class="timeline-body-content">
												<span class="font-grey-cascade"> Payment Completed</span>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-body inactiveBox">
                                            ...
                                            <div class="timeline-body-content">
                                            	<span class="font-grey-cascade"> Payment is pending</span>
                                            </div>
                                        </div>
                                    </div>
                            @endif
                            
                            @if(\Auth::user()->payment_status == 1 && @$act->first_name != '' && @$act->last_name != '' && @$act->ethnicity != '' && @$verify == 1 && \Auth::user()->email != '' && @$act->gender != '' && @$act->age != '' && @$act->vocalRange != '' && @$act->feet != '' && @$act->weight != '' && @$act->hair != '' && @$act->eyes != '' && @$act->from != '' && @$act->to != '' && @$act->auditionType != '')
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-body inactiveBox">
                                        <div class="timeline-body-head">
                                            <div class="timeline-body-head-caption">
                                                <span class="timeline-body-alerttitle font-red">Application Print-Out</span>
                                            </div>
                                            <div class="timeline-body-head-actions">                     
                                                <a href="{{ route('actor::actorPreview') }}" class="btn btn-primary">Click here to Print Application</a>         
                                            </div>
                                        </div>
                                        <div class="timeline-body-content">
                                            <span class="font-grey-cascade"> StrawHat Application Print-Out</span>
                                        </div>
                                    </div>
                                </div> 
                            @endif
                            ...
                            @if(@$hardcopy == 0)
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-body inactiveBox">
                                        ...
                                        <div class="timeline-body-content">
                                            <span class="font-grey-cascade">Send in a check and a Hard Copy of your Resume & Photo</span>
                                        </div>
                                    </div>
                                </div>
                            @elseif(@$hardcopy == 2)
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-body inactiveBox">
                                        ...
                                        <div class="timeline-body-content">
                                            <span class="font-grey-cascade">Hardcopy Received Waiting for Strawhat Panelist to approve.</span>
                                        </div>
                                    </div>
                                </div>
                            @elseif(@$hardcopy == 1)
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-body inactiveBox">
                                        ...
                                        <div class="timeline-body-content">
                                            <span class="font-grey-cascade">Issue with your paperwork, a StrawHat representative will be reaching out to you shortly</span>
                                        </div>
                                    </div>
                                </div>
                            @elseif(@$hardcopy == 3)
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-body activeBox">
                                        ...
                                        <div class="timeline-body-content">
											<span class="font-grey-cascade">Congratulations, You're Selected for Audition.</span>
                                        </div>
                                    </div>
                                </div>
                            @elseif(@$hardcopy == 4)
                            <div class="timeline-item">
                                ...
                                <div class="timeline-body inactiveBox">
                                    ...
                                    <div class="timeline-body-content">
										<span class="font-grey-cascade">Sorry! You're Not Selected for Audition.</span>
                                    </div>
                                </div>
                            </div>
                        @endif
