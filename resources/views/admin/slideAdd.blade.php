        ...
        <div class="row">
          <div class="col-md-12">
            <div class="portlet light ">
              ...
              <li class="active"> <a href="#tab_1_2" data-toggle="tab">Add Slide</a> </li>
              </ul>
              </div>
              ...
              <!--TAB -->
                  <div class="tab-pane active" id="tab_1_2"> 
                    {{ Form::open(['route' => ['admin::adminSlideshowStoreSlide',$id], 'class' => 'form-horizontal','method' => 'post', 'files' => true]) }}
