            ...
            <div class="portlet-body form">
                ...
                <form method="POST" class="form-horizontal form-validate-auto"  enctype="multipart/form-data">
                    ...
                    <div class="form-body">
					        ...
					        <div class="col-md-12">
					            <div class="form-group">
					                ...
					                <label class="control-label"><strong>Company Description</strong></label>
					                    {!! Form::textarea('company_description',isset($theater[0]['company_description']) ? $theater[0]['company_description'] : null, ['class' => 'form-control', 'placeholder' => 'company_description']) !!}
						            </div>
					        	</div>
					    	</div>
					    </div>
					        ...
					        <div class="col-md-6">
					            <div class="form-group" {{ $errors->has("mailing") ? "has-error":"" }}'>
					                ...
					                <div class="col-md-9">
					                    ...
					                    <span class="help-block"> {{ $errors->first("mailing") }} </span>
					                </div>
					        	</div>
					    	</div>
					        <div class="col-md-6">
						...
						</div><div class="clearfix" style="margin-top:20px; margin-bottom: 20px;"></div>
					    <div class="row">
					        <div class="col-md-12"><strong>Representatives who will attend StrawHat:</strong></div>
					        <div class="col-md-12">
